...
const Home = () => {
  return (
    <div className="flex flex-col items-center text-center justify-center max-w-[98vw] px-6 pb-12">
      <h1 className="text-3xl md:text-6xl font-extrabold mb-1">The Ultimate Component Library</h1>
      <p className="text-lg md:text-2xl font-bold text-foreground/60 mb-4 ">
